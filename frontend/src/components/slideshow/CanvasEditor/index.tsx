...
import { TextBox, CanvasEditorProps, PREVIEW_WIDTH, PREVIEW_HEIGHT, DEFAULT_TEXT_BOX } from './types';
...
export const CanvasEditor = forwardRef<CanvasEditorRef, CanvasEditorProps>(({
  ...
  useEffect(() => {
    ...
    const textBoxesToRender = isEditing && selectedTextId
...
export { PREVIEW_WIDTH, PREVIEW_HEIGHT, EXPORT_WIDTH, EXPORT_HEIGHT, DEFAULT_TEXT_BOX } from './types';
